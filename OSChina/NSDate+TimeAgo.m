...
- (NSString *)timeAgo
{
    ...
    else if(deltaSeconds < 60)
    {
        ...
        return [NSString stringWithFormat:@"%f 秒前",deltaSeconds];
    ...
    else if (deltaMinutes < 60)
    {
        ...
        return [NSString stringWithFormat:@"%f 分钟前",deltaSeconds];
    }
    ...
    else if (deltaMinutes < (24 * 60))
    {
        ...
        return [NSString stringWithFormat:@"%d 小时前",minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 7))
    {
        ...
        return [NSString stringWithFormat:@"%d 天前",minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 31))
    {
        ...
        return [NSString stringWithFormat:@"%d 周前",minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
        ...
        return [NSString stringWithFormat:@"%d 月前",minutes];
    }
    ...
    return [NSString stringWithFormat:@"%d 年前",minutes];
}
